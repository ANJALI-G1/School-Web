...
const ContactPage = () => {
    ...
    return (
        <div className="bg-gray-100 font-['Plus_Jakarta_Sans',_sans-serif] overflow-x-hidden">
             <motion.div 
            initial="hidden"
            animate="show"
        ...
        >
            <motion.div variants={itemVariants} className="mb-8">
                <h1 className="text-3xl md:text-4xl font-bold text-gray-800 text-center">Contact Us</h1>
            ...
            <motion.div variants={itemVariants}>
                <h2 className="text-2xl font-semibold text-gray-800 mb-6">Admission Enquiry</h2>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div className="pt-2">
                                <motion.button
                                    ...
                                    className="w-full md:w-auto px-8 py-3 bg-blue-600 text-white font-medium rounded-lg hover:bg-blue-700 transition"
                                    whileHover={{ scale: 1.02 }}
                                    whileTap={{ scale: 0.98 }}
                                >
                                    {state.submitting ? 'Submitting...' : <button onClick={()=>setSubmitted(!submitted)}>Submit</button>}
                                </motion.button>
                            </div>
                        </form>
                    </motion.div>
